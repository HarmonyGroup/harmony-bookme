  ...
  return (
    <div className="block rounded-lg relative">
      ...
      <div className="bg-white rounded-b-lg py-4">
        ...
        <p className="text-gray-600 text-xs mt-2">Victoria Island, Lagos</p>
        <div className="flex items-center gap-1 mt-2">
          <p className="text-gray-600 text-xs">3 beds</p>
          <RxDividerVertical className="text-gray-600" />
          <p className="text-gray-600 text-xs">2 baths</p>
          <RxDividerVertical className="text-gray-600" />
          <p className="text-gray-600 text-xs">2 parking</p>
        </div>
