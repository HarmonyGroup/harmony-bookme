...
const VendorBanner = () => {
  return (
    <section>
      <div className="mx-auto w-full max-w-7xl px-5 md:px-10 pt-6 pb-20">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-6">
          ...
          <div className="vendor-banner-card p-5 md:p-6">
            ...
            {/* <Link
              href={"/auth/vendor/signup"}
              className="relative text-white border rounded-full font-semibold z-10 px-3.5 py-1.5"
            >
              Get started
            </Link> */}
            <Image
          ...
          {/* <div className="h-72 w-full relative rounded-2xl bg-gray-300 lg:col-span-2 overflow-hidden">
            <Image
              src={
                "https://img.freepik.com/free-photo/tropical-vacation-spot_23-2151982390.jpg?uid=R137948985&ga=GA1.1.1977978369.1744267390&semt=ais_hybrid&w=740"
              }
