...
const AllCinemasTable = () => {
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-4">
            <div className="relative hidden md:block">
              ...
              <Input
                ...
                placeholder="Search cinemas here"
                value={search}
        ...
        {isLoading ? (
              ...
              {data?.data?.map((cinema) => (
                <TableRow key={cinema?._id}>
                  ...
                  <TableCell className="text-gray-700 text-xs font-semibold pl-4 py-5">
                    <Link
                      href={`/vendor/accommodations/${cinema?.slug}`}
                  ...
                  <TableCell className="text-gray-700 text-xs uppercase">
                   {cinema?.operatingHours?.startTime} AM - {cinema?.operatingHours?.endTime} PM
                  </TableCell>
                  ...
                  <TableCell className="text-right pr-4">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(`/vendor/cinemas/${cinema?.slug}`)
                          }
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            router.push(`/vendor/cinema/${cinema?.slug}/edit`)
                          }
                          className="text-gray-700 text-xs font-medium cursor-pointer"
                        >
                          <svg
          ...
          <div className="flex flex-col items-center justify-center gap-2 py-20 min-h-[400px]">
            ...
            <p className="text-gray-500 text-xs text-center max-w-md">
              Create cinemas and they&apos;ll show up here.
            </p>
          </div>
        )}
      </div>
      <ActionModal
        variant="delete"
        heading="Delete Cinema"
        description="Are you sure you want to delete this cinema? This action cannot be undone."
        showModal={deleteModal}
        toggleModal={() => {setDeleteModal(false); setSelectedCinema(null);}}
...
export default AllCinemasTable;