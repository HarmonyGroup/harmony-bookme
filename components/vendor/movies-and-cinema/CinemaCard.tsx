...
import { Cinema } from "@/types/vendor/movies-and-cinema";
          ...
          <>
            <Carousel className="w-full h-full" setApi={setApi}>
              <CarouselContent className="h-full">
                {cinema.images.map((image, index) => (
                  <CarouselItem key={index} className="h-full">
                    <div className="relative w-full h-48">
                      <Image
                        src={image}
                        alt={`${cinema?.title} - Image ${index + 1}`}
      ...
      <div className="p-4">
        <div className="space-y-2">
              ...
              <DropdownMenuContent align="end">
                <DropdownMenuItem>
                  <Link
                    ...
                    href={`/vendor/events/${cinema.slug}/edit`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
          ...
          <p className="text-[11px]/relaxed text-gray-700 line-clamp-2 font-light">
            {cinema?.operatingHours?.startTime} AM -{" "}
            {cinema?.operatingHours?.endTime} PM
          </p>
