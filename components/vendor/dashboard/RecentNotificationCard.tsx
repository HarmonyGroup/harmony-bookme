...
const RecentNotificationCard = ({
  ...
  return (
    <div className="hover:bg-muted/60 flex items-center justify-between rounded-md px-2 py-2.5 cursor-pointer transition-colors ease-in-out duration-300">
      <div className="flex items-center gap-2">
        <div className="flex items-center justify-center bg-gradient-to-tr from-sky-400 to-blue-500 size-5 rounded-full">
          {/* <svg
