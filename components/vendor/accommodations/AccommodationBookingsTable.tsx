...
import { VendorBookingsResponse } from "@/types/booking";

const AccommodationBookingsTable = () => {
          ...
          {isLoading ? (
                        ...
                        <span
                          className={cn(
                            ...
                            booking?.status === "requested" &&
                              "text-orange-700 bg-orange-100/60 border-orange-200"
                          )}
                        >
                          {booking?.status}
                        </span>
            ...
            <div className="flex flex-col items-center justify-center gap-2 py-20 min-h-[400px]">
              ...
              <p className="text-gray-500 text-xs text-center max-w-md">
                Receive accommodation bookings and they&apos;ll show up here.
              </p>
            </div>
          )}
        </div>
...
export default AccommodationBookingsTable;