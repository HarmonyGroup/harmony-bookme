...
import { useGetAdminTransactions } from "@/services/admin/transactions";
                  ...
                  <TableCell className="text-gray-500 text-xs font-medium">
                    <div className="flex items-center gap-2">
                      {payment?.vendor?.avatar ? (
                        <Image
                          src={payment.vendor.avatar}
                          alt={payment.vendor.businessName || `${payment.vendor.firstName} ${payment.vendor.lastName}`}
                          width={24}
                          height={24}
                          className="rounded-full"
                        />
                        ...
                        <div className="w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center">
                          <span className="text-xs font-medium text-gray-600">
                            {(payment.vendor.businessName || `${payment.vendor.firstName} ${payment.vendor.lastName}`).charAt(0).toUpperCase()}
                          </span>
                        </div>
                      )}
                      <div>
                        <p className="font-medium">
                          {payment.vendor.businessName || `${payment.vendor.firstName} ${payment.vendor.lastName}`}
                        </p>
                        {/* <p className="text-gray-400 text-[10px]">
